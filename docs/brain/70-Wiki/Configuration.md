...
Script" OutputChannel, one line per statement. See [[Commands]].
...
connection changes, and closed when the extension is deactivated. See [[Oracle-direct-execution|Direct Oracle Execution]].

## Reporters

| Setting | Default | Description |
|---|---|---|
| `utplsql.additionalReporters` | `[]` | Extra reporters included in every execution. See [[Reporters]]. |
